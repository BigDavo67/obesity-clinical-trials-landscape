...
seed_file = processed / "phase47_mechanism_seed_v2.csv"

focal = pd.read_csv(focal_map_file)
seed = pd.read_csv(seed_file)

print("=== Phase 4.7: mechanism / target / modality stage 1 ===")
...
stage1["scope_review_flag"] = stage1["scope_review_flag"].fillna(False)
...
scope_flags = review[
    review["scope_review_flag"].fillna(False).astype(bool)
].copy()
