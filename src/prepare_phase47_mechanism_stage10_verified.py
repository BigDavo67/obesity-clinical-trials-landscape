...
expected_stage10_seed = {
    "gub014295": "VERIFIED",
    "gzc8072": "VERIFIED",
    "hec88473": "VERIFIED",
    "hm11260c": "VERIFIED_ALIAS",
    "hm15136": "VERIFIED",
    "hm17321": "VERIFIED",
    "hs235": "VERIFIED",
    "ht-6184": "VERIFIED_ALIAS",
}
...
for therapy_name, expected_status in expected_stage10_seed.items():
...
if len(seed) != 252:
    seed_errors.append(
        f"expected exactly 252 seed rows, found {len(seed)}"
    )

if seed_errors:
    raise ValueError(
        "Wrong or stale Stage-10 mechanism seed loaded:\n- "
        + "\n- ".join(seed_errors)
    )

print("Stage-10 seed sanity check: PASSED")

print("=== Phase 4.7: mechanism / target / modality stage 10 ===")
