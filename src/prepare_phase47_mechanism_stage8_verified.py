...
seed_file = processed / "phase47_mechanism_seed_stage8_verified.csv"
...
expected_stage8_seed = {
    "dmxb-a": "VERIFIED",
    "dose escalation of sa030": "VERIFIED_ALIAS",
    "dr10624 for": "VERIFIED_ALIAS",
    "ecc4703": "VERIFIED",
    "efocipegtrutide": "VERIFIED",
    "elecoglipron": "VERIFIED",
    "ent-03": "VERIFIED",
    "entacapone": "VERIFIED",
}
...
for therapy_name, expected_status in expected_stage8_seed.items():
...
if len(seed) != 214:
    seed_errors.append(
        f"expected exactly 214 seed rows, found {len(seed)}"
    )

if seed_errors:
    raise ValueError(
        "Wrong or stale Stage-8 mechanism seed loaded:\n- "
        + "\n- ".join(seed_errors)
    )

print("Stage-8 seed sanity check: PASSED")

print("=== Phase 4.7: mechanism / target / modality stage 8 ===")
