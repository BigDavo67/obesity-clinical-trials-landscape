...
seed_file = processed / "phase47_mechanism_seed_stage6_verified.csv"
...
expected_stage6_seed = {
    "bardoxolone methyl": "VERIFIED",
    "bio101": "VERIFIED",
    "bivamelagon": "VERIFIED",
    "bmf-650": "VERIFIED",
    "bms-963272": "VERIFIED",
    "bremelanotide": "VERIFIED",
    "brenipatide": "VERIFIED",
    "cg-0416": "VERIFIED",
}
...
for therapy_name, expected_status in expected_stage6_seed.items():
...
if len(seed) != 176:
    seed_errors.append(
        f"expected exactly 176 seed rows, found {len(seed)}"
    )

if seed_errors:
    raise ValueError(
        "Wrong or stale Stage-6 mechanism seed loaded:\n- "
        + "\n- ".join(seed_errors)
    )

print("Stage-6 seed sanity check: PASSED")

print("=== Phase 4.7: mechanism / target / modality stage 6 ===")
